...
function TransferIcon({ color = 'black', ...props }: SvgProps & SvgIconProps) {
  return (
    <Svg
      width="30"
      height="30"
    ...
    >
      <Path
        d="M385.9,14.2H104.3c-28.2,0-51.1,22.9-51.1,51.1v233.1l-32.3-32.3c-4.8-4.8-12.5-4.8-17.3,0s-4.8,12.5,0,17.3l53.3,53.3
      ...
      />
      <Path
        d="M416,153.5l-53.3,53.3c-4.8,4.8-4.8,12.5,0,17.3c2.4,2.4,5.5,3.6,8.7,3.6s6.3-1.2,8.7-3.6l32.4-32.4v233.1
      ...
      />
      <Path
        d="M245.1,136.7c-6.8,0-12.3,5.5-12.3,12.3v18.8h-1.6c-23.4,0-42.5,20.1-42.5,44.7s19.1,44.7,42.5,44.7h27.6
